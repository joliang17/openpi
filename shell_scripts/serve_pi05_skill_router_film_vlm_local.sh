#!/bin/bash
# Run the pi0.5 skill-router film+VLM checkpoint as a local policy server on CUDA GPU 1.
set -euo pipefail
...
STAGE2_CONFIG="${STAGE2_CONFIG:-pi05_libero_skill_router_stage2_film_vlm}"
