...
#SBATCH --job-name=eval_srjllm
#SBATCH --output=slurm_output/eval_pi05_skill_router_joint_llm_init.log
#SBATCH --error=slurm_output/eval_pi05_skill_router_joint_llm_init.log
...
EXP_NAME="pi05_skill_router_joint_llm_init"
POLICY_CONFIG="pi05_libero_vlm_lora_skill_router_joint_llm_skill_init"
PORT="${PORT:-8027}"
CKPT="${CKPT:-/fs/nexus-projects/wilddiffusion/vla/openpi_vlm_lora_skill_router_llm_skill_init/pi05_libero_vlm_lora_skill_router_joint_llm_skill_init/pi05_vlm_lora_skill_router_joint_llm_skill_init_20260515_120640/29999}"
