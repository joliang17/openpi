...
#SBATCH --job-name=eval_lorav1
#SBATCH --output=slurm_output/eval_pi05_libero_lora_v1.log
#SBATCH --error=slurm_output/eval_pi05_libero_lora_v1.log
...
EXP_NAME="pi05_libero_lora_skill_router_joint"
POLICY_CONFIG="pi05_libero_lora_skill_router_joint"
PORT="${PORT:-8021}"
CKPT="${CKPT:-/fs/nexus-projects/wilddiffusion/vla/openpi_lora_skill_router_joint/pi05_libero_lora_skill_router_joint/pi05_lora_skill_router_joint_20260517_155626/29999}"
