#!/bin/bash
# Run the pi0.5 freeze-VLM LIBERO checkpoint as a local policy server.
set -euo pipefail
...
CKPT="${CKPT:-/fs/nexus-scratch/yliang17/Research/VLA/openpi/checkpoints/pi05_libero_action_expert/pi05_action_expert_jax_v2/29999}"
PORT="${PORT:-8020}"
