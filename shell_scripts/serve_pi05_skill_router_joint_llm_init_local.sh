#!/bin/bash
# Run the pi0.5 VLM-LoRA skill-router joint (LLM skill init) checkpoint as a local policy server.
set -euo pipefail
...
POLICY_CONFIG="${POLICY_CONFIG:-pi05_libero_vlm_lora_skill_router_joint_llm_skill_init}"
