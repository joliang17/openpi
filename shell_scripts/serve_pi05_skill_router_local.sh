...
STAGE2_CONFIG="${STAGE2_CONFIG:-pi05_libero_vlm_lora_skill_router_stage2}"
STAGE2_EXP="${STAGE2_EXP:-pi05_vlm_lora_skill_router_stage2_from_pi05_vlm_lora_skill_router_stage1_20260516_011543_20260516_011543}"
PORT="${PORT:-8010}"
