...
KI_BASE_PARAMS = os.getenv(
    "KI_BASE_PARAMS",
    "/fs/nexus-projects/wilddiffusion/vla/openpi_ki/pi05_libero_ki_vlm_lora_action_expert/"
    "pi05_ki_vlm_lora_action_expert_20260509_120950/29999/params",
)
VLM_LORA_BASE_PARAMS = os.getenv(
    "VLM_LORA_BASE_PARAMS",
    "/fs/nexus-scratch/yliang17/Research/VLA/openpi/checkpoints_vlm_lora_action_expert/"
    "pi05_libero_vlm_lora_action_expert/pi05_vlm_lora_action_expert_20260508_155051/29999/params",
)
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_vlm_lora_skill_router_stage1",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_vlm_lora_skill_router_stage2",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        ema_decay=0.999,
        weight_loader=weight_loaders.PartialCheckpointWeightLoader(
            os.getenv("OPENPI_SKILL_STAGE1_PARAMS", VLM_LORA_BASE_PARAMS),
            missing_regex=".*skill_.*",
        ),
        pytorch_weight_path=f"{os.getenv('OPENPI_DATA_HOME')}/openpi-assets/checkpoints/pi05_base_torch",
        num_train_steps=30_000,
    ...
    TrainConfig(
        name="pi05_libero_vlm_lora_skill_router_joint",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_vlm_lora_skill_effect_gate_router_joint",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_vlm_lora_gated_film_skill_router_joint",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        freeze_filter=nnx.All(
            ...
            nnx.Not(
                nnx.Any(
                    ...
                    nnx_utils.PathRegex(".*skill_emb_bank.*"),
                    nnx_utils.PathRegex(".*skill_to_action_film.*"),
                    nnx_utils.PathRegex(".*skill_to_action_film_gate.*"),
                )
            ),
        ),
    ),
    # Same as pi05_libero_vlm_lora_skill_router_joint, but the action expert is
    # also LoRA-adapted (gemma_300m_lora) so the trainable-parameter set matches
    # pi05_libero_lora_v1: only LoRA adapters on both Gemma towers are trained,
    # plus the (non-llm) action projections, vision encoder, and skill-routing
    # modules. The action-expert base weights are frozen.
    TrainConfig(
        name="pi05_libero_lora_skill_router_joint",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        pytorch_weight_path=f"{os.getenv('OPENPI_DATA_HOME')}/openpi-assets/checkpoints/pi05_base_torch",
        num_train_steps=30_000,
        # LoRA-derived freeze filter (same pattern as pi05_libero_lora_v1):
        # freezes all .*llm.* non-LoRA params; skill modules / action projections
        # / vision encoder are not .*llm.* so they stay trainable automatically.
        freeze_filter=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_lora_gated_film_skill_router_joint",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    # Serving-only ablation: same architecture / checkpoint as
    # pi05_libero_vlm_lora_skill_router_joint, but the skill embedding bank is
    # randomly permuted at inference (skill_eval_mode="shuffle"). Point
    # --policy.dir at the trained joint checkpoint to test whether the skill
    # routing actually contributes to performance.
    TrainConfig(
        name="pi05_libero_vlm_lora_skill_router_joint_shuffle_eval",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_vlm_lora_skill_router_joint_llm_skill_init",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        optimizer=_optimizer.AdamW(clip_gradient_norm=1.0),
        ema_decay=None,
        weight_loader=weight_loaders.LlmSkillEmbeddingCheckpointWeightLoader(
            "gs://openpi-assets/checkpoints/pi05_base/params",
            skill_vocab=("close", "open", "pick", "place", "turn"),
        ),
        pytorch_weight_path=f"{os.getenv('OPENPI_DATA_HOME')}/openpi-assets/checkpoints/pi05_base_torch",
    ...
    TrainConfig(
        name="pi05_libero_ki_skill_router_stage1",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=True,
    ...
    TrainConfig(
        name="pi05_libero_ki_skill_router_stage2",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=True,
        ...
        ema_decay=0.999,
        weight_loader=weight_loaders.PartialCheckpointWeightLoader(
            os.getenv("OPENPI_SKILL_STAGE1_PARAMS", KI_BASE_PARAMS),
            missing_regex=".*skill_.*",
        ),
        pytorch_weight_path=f"{os.getenv('OPENPI_DATA_HOME')}/openpi-assets/checkpoints/pi05_base_torch",
        num_train_steps=30_000,
    ...
    TrainConfig(
        name="pi05_libero_skill_router_stage2_adarms_only",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
            ...
            num_skills=5,
            skill_stage="action",
            skill_inject_adarms=True,
            use_skill_action_film=False,
            skill_inject_vlm_hidden=False,
            skill_inject_state_token=False,
        ),
        data=LeRobotLiberoDataConfig(
    ...
    TrainConfig(
        name="pi05_libero_skill_router_stage2_film_only",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_skill_router_stage2_film_vlm",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
        ...
        freeze_filter=nnx.All(
            ...
            nnx.Not(
                nnx.Any(
                    ...
                    nnx_utils.PathRegex(".*skill_emb_bank.*"),
                    nnx_utils.PathRegex(".*skill_to_action_film.*"),
                    nnx_utils.PathRegex(".*skill_to_vlm_hidden.*"),
                )
            ),
        ),
    ),
